...
=======
    // Helper: buat Date dari offset hari & jam tertentu
...
=======
    ...
    fun add(data: ShipmentModel) { shipmentList.add(data) }
    fun getAll(): List<ShipmentModel> = shipmentList.toList()
    fun getTotal(): Int = shipmentList.size
    fun update(index: Int, data: ShipmentModel) { if (index in shipmentList.indices) shipmentList[index] = data }
    fun delete(index: Int) { if (index in shipmentList.indices) shipmentList.removeAt(index) }
>>>>>>> 5362414a4bd048e554ae5e08085736521003c564
}