...
class ResiActivity : AppCompatActivity() {
    ...
    private fun buildHtml(
        resi: String, name: String, phone: String,
        address: String, city: String, type: String,
        weightStr: String, payment: String, totalPrice: String
    ): String = """
        <!DOCTYPE html>
        <html lang="id">
        <head>
            ...
            <style>
                ...
                .header { position: relative; border-bottom: 2px dashed #ccc; padding-bottom: 16px; margin-bottom: 20px; min-height: 100px; }
                ...
                @media print { body { background: white; padding: 0; } .receipt { box-shadow: none; border: 1px solid #ddd; } }
            </style>
        </head>
        <body>
        <div class="receipt">
            ...
            <div class="section">
                ...
                <div class="row">
                    ...
                    <div class="item"><div class="label">Nomor Telepon</div><div class="value">$phone</div></div>
                </div>
                <div class="row">
